...
/**
 * {@link TranslationLocaleListener Validator} checking that the locale is unique (region-language-variants).
 *
 * @author Sebastien Gerard
 */
@Component
public class TranslationLocaleUniqueValidator implements TranslationLocaleListener {
