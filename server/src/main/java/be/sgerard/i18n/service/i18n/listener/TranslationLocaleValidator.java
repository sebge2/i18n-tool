...
/**
 * {@link TranslationLocaleListener Validator} checking that the following expectations:
 * <ul>
 ...
 */
@Component
public class TranslationLocaleValidator implements TranslationLocaleListener {
    ...
    public TranslationLocaleValidator() {
    }
