 ...
 */
public class GitHubBranchCreatedEventDtoTest {

    @Test
    public void deserialize() throws JsonProcessingException {
        final GitHubBranchCreatedEventDto event = new ObjectMapper().readValue(getSampleEvent(), GitHubBranchCreatedEventDto.class);
