...
export class WorkspaceBundleFileSelectorComponent implements OnInit, OnDestroy, AfterViewInit, DoCheck, ControlValueAccessor, MatFormFieldControl<BundleFile> {
    ...
    constructor(private injector: Injector,
        ...
        this.bundleFiles = this._workspace$
            .pipe(
