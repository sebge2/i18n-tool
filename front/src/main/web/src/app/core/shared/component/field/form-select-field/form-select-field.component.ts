...
export class FormSelectFieldComponent<E>
  implements OnInit, OnDestroy, AfterViewInit, DoCheck, ControlValueAccessor, MatFormFieldControl<E[]>
{
  ...
  constructor(
    ...
    this.parts.valueChanges.pipe(takeUntil(this._destroyed$)).subscribe(() => {
