...
export class SnapshotService {
  ...
  public create1(
    body: SnapshotCreationDto,
    observe?: 'response',
    reportProgress?: boolean
  ): Observable<HttpResponse<SnapshotDto>>;
  public create1(
    body: SnapshotCreationDto,
    observe?: 'events',
    reportProgress?: boolean
  ): Observable<HttpEvent<SnapshotDto>>;
  ...
  public exportZip(id: string, observe: any = 'body', reportProgress: boolean = false): Observable<any> {
    ...
    return this.httpClient.request<Blob>(
      'get',
      `${this.basePath}/api/snapshot/${encodeURIComponent(String(id))}/file`,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
        observe: observe,
  ...
  public restore(id: string, action?: string, observe: any = 'body', reportProgress: boolean = false): Observable<any> {
    ...
    return this.httpClient.request<SnapshotDto>(
      'post',
      `${this.basePath}/api/snapshot/${encodeURIComponent(String(id))}/do`,
      {
