...
import { UserPreferencesDto } from '../model/userPreferencesDto';
...
export class UserPreferencesService {
  ...
  ): Observable<HttpResponse<UserPreferencesDto>>;
  public getCurrentUserPreferences(
    observe?: 'events',
    reportProgress?: boolean
  ): Observable<HttpEvent<UserPreferencesDto>>;
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public updateCurrentUserPreferences(
