...
export class PullRequestService {
  ...
  public getStatus(
    ...
    return this.httpClient.request<string>(
      'get',
      `${this.basePath}/api/repository/${encodeURIComponent(
        String(repositoryId)
      )}/github-pull-request/${encodeURIComponent(String(number))}/status`,
      {
  ...
  public listAllRequests(
    observe?: 'response',
    reportProgress?: boolean
  ): Observable<HttpResponse<Array<GitHubPullRequestDto>>>;
  public listAllRequests(
    observe?: 'events',
    reportProgress?: boolean
  ): Observable<HttpEvent<Array<GitHubPullRequestDto>>>;
  ...
  public listRequests(
    ...
    observe?: 'body',
    reportProgress?: boolean
  ): Observable<Array<GitHubPullRequestDto>>;
  public listRequests(
    repositoryId: string,
    observe?: 'response',
    reportProgress?: boolean
  ...
  public listRequests(repositoryId: string, observe: any = 'body', reportProgress: boolean = false): Observable<any> {
    ...
    return this.httpClient.request<Array<GitHubPullRequestDto>>(
      'get',
      `${this.basePath}/api/repository/${encodeURIComponent(String(repositoryId))}/github-pull-request`,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
        observe: observe,
