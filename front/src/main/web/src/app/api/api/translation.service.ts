...
export class TranslationService {
  ...
  public searchTranslations(
    body: TranslationsSearchRequestDto,
    action?: string,
    observe?: 'body',
    reportProgress?: boolean
  ): Observable<TranslationsPageDto>;
  public searchTranslations(
    body: TranslationsSearchRequestDto,
    action?: string,
    observe?: 'response',
    reportProgress?: boolean
  ): Observable<HttpResponse<TranslationsPageDto>>;
  public searchTranslations(
    body: TranslationsSearchRequestDto,
    action?: string,
    observe?: 'events',
    reportProgress?: boolean
  ): Observable<HttpEvent<TranslationsPageDto>>;
  public searchTranslations(
    body: TranslationsSearchRequestDto,
    action?: string,
    observe: any = 'body',
  ...
  public updateTranslation(
    ...
    return this.httpClient.request<TranslationDto>(
      'put',
      `${this.basePath}/api/translation/bundle-key/${encodeURIComponent(
        String(bundleKeyId)
      )}/locale/${encodeURIComponent(String(localeId))}`,
      {
        body: body,
        withCredentials: this.configuration.withCredentials,
        headers: headers,
  ...
  public updateTranslations(
    body?: Array<TranslationUpdateDto>,
    observe?: 'body',
    reportProgress?: boolean
  ...
  public updateTranslations(
    ...
    observe?: 'response',
    reportProgress?: boolean
  ): Observable<HttpResponse<Array<TranslationDto>>>;
  public updateTranslations(
    body?: Array<TranslationUpdateDto>,
    observe?: 'events',
    reportProgress?: boolean
  ): Observable<HttpEvent<Array<TranslationDto>>>;
  public updateTranslations(
    body?: Array<TranslationUpdateDto>,
    observe: any = 'body',
    reportProgress: boolean = false
