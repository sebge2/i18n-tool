...
export const APIS = [AuthenticationService, EventService, GitHubService, PullRequestService, RepositoryService, TranslationService, TranslationLocaleService, UserService, UserLiveSessionService, UserPreferencesService, WorkspaceService];
