...
export class RepositoryService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public executeRepositoryAction(id: string, action: string, observe?: 'body', reportProgress?: boolean): Observable<InlineResponse200Dto>;
    public executeRepositoryAction(id: string, action: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<InlineResponse200Dto>>;
    public executeRepositoryAction(id: string, action: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<InlineResponse200Dto>>;
