...
export class RepositoryService {
  ...
  ): Observable<HttpResponse<InlineResponse201Dto>>;
  public create2(
    body: Body1Dto,
    observe?: 'events',
    reportProgress?: boolean
  ): Observable<HttpEvent<InlineResponse201Dto>>;
  ...
  public delete3(id: string, observe: any = 'body', reportProgress: boolean = false): Observable<any> {
    ...
    return this.httpClient.request<InlineResponse201Dto>(
      'delete',
      `${this.basePath}/api/repository/${encodeURIComponent(String(id))}`,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
        observe: observe,
  ...
  public findAll3(
    observe?: 'body',
    reportProgress?: boolean
  ): Observable<Array<GitHubRepositoryDto | GitRepositoryDto>>;
  public findAll3(
    observe?: 'response',
    reportProgress?: boolean
  ): Observable<HttpResponse<Array<GitHubRepositoryDto | GitRepositoryDto>>>;
  public findAll3(
    observe?: 'events',
    reportProgress?: boolean
  ): Observable<HttpEvent<Array<GitHubRepositoryDto | GitRepositoryDto>>>;
  public findAll3(observe: any = 'body', reportProgress: boolean = false): Observable<any> {
    ...
    return this.httpClient.request<Array<GitHubRepositoryDto | GitRepositoryDto>>(
      'get',
      `${this.basePath}/api/repository`,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
        observe: observe,
  ...
  public initialize(
    ...
    observe?: 'body',
    reportProgress?: boolean
  ): Observable<InlineResponse201Dto>;
  public initialize(
    id: string,
    action?: string,
    observe?: 'response',
  ...
  public initialize(
    ...
    return this.httpClient.request<InlineResponse201Dto>(
      'post',
      `${this.basePath}/api/repository/${encodeURIComponent(String(id))}/do`,
      {
