...
export class GitHubService {
    ...
    /**
     * GitHub Web-hook notifying events on the repository. Only called by GitHub.com
     * 
     * @param body 
    ...
    public handle(body?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<string>('post',`${this.basePath}/api/git-hub/event`,
            {
                body: body,
