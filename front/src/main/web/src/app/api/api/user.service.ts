...
export class UserService {
  ...
  public getUserAvatar(
    ...
    observe?: 'body',
    reportProgress?: boolean
  ): Observable<FluxDataBufferDto>;
  public getUserAvatar(
    id: string,
    body?: Object,
    observe?: 'response',
    reportProgress?: boolean
  ): Observable<HttpResponse<FluxDataBufferDto>>;
  public getUserAvatar(
    id: string,
    body?: Object,
    observe?: 'events',
    reportProgress?: boolean
  ): Observable<HttpEvent<FluxDataBufferDto>>;
  public getUserAvatar(
    id: string,
    body?: Object,
    observe: any = 'body',
    ...
    // to determine the Accept header
    let httpHeaderAccepts: string[] = ['*/*', 'image/png'];
    const httpHeaderAcceptSelected: string | undefined = this.configuration.selectHeaderAccept(httpHeaderAccepts);
    if (httpHeaderAcceptSelected != undefined) {
      headers = headers.set('Accept', httpHeaderAcceptSelected);
    }
    ...
    return this.httpClient.request<FluxDataBufferDto>(
      'get',
      `${this.basePath}/api/user/${encodeURIComponent(String(id))}/avatar`,
      {
        body: body,
        withCredentials: this.configuration.withCredentials,
        headers: headers,
  ...
  public updateUserAvatar(body?: Object, observe: any = 'body', reportProgress: boolean = false): Observable<any> {
    ...
    // to determine the Content-Type header
    const consumes: string[] = ['image/jpeg', 'image/png'];
    const httpContentTypeSelected: string | undefined = this.configuration.selectHeaderContentType(consumes);
    if (httpContentTypeSelected != undefined) {
      headers = headers.set('Content-Type', httpContentTypeSelected);
    }
