...
@NgModule({
  declarations: [Error403Component, Error404Component, ErrorStandardComponent, ErrorMessageComponent],
  imports: [CommonModule, RouterModule.forChild(appRoutes), CoreSharedModule],
