...
execCmd(
  `java -classpath ${swaggerLocation} io.swagger.codegen.v3.cli.SwaggerCodegen generate -i ${apiUrl} -l typescript-angular --additional-properties classPrefix='' --additional-properties ngVersion=${angularVersion} -o ${sourceLocation} -a "Authorization:Basic YWRtaW46YWRtaW4="`,
);
